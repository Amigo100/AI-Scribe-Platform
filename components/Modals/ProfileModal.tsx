...
export const ProfileModal = () => {
  ...
  const handleSaveProfile = () => {
    // Example: store signOff in global state
        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="md:w-1/2 md:pr-4">
            <label className="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-200">
              ...
              <input
                type="text"
                className="mt-1 block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded dark:bg-gray-700 dark:text-gray-100"
                value={fullName}
            ...
            <label className="block mb-4 text-sm font-medium text-gray-700 dark:text-gray-200">
              ...
              <textarea
                className="mt-1 block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded dark:bg-gray-700 dark:text-gray-100 h-20"
                value={signOff}
          ...
          {/* Right column: Additional Info or "Recent Changes" */}
