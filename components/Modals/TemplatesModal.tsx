...
export const TemplatesModal = () => {
  ...
  const handleNewTemplate = () => {
    ...
    // Immediately expand and edit new template
  ...
  const handleExportAsPDF = (tpl: Prompt) => {
    ...
    pdfMake
      ...
      .download(`${fileNameTimeStamp}_${tpl.name}.pdf`);
  };
  ...
  return (
    ...
    <div className="fixed inset-0 z-[999] flex items-center justify-center bg-black/50">
      {/* Modal Container */}
      <div className="w-full max-w-2xl max-h-[90vh] overflow-auto rounded-md shadow-lg
        bg-white dark:bg-[#343541] text-black dark:text-white border border-gray-300 dark:border-gray-700 p-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-wrap gap-2">
            <button
              ...
              className="rounded-md bg-gray-900 px-3 py-1 text-sm font-semibold text-white
                  ...
                  <div className="mt-2 text-sm">
                    {isEditing ? (
                      <>
                        ...
                        <input
                          className="w-full mb-2 px-3 py-2 text-sm rounded-md border border-gray-300
                            dark:border-gray-600 bg-white dark:bg-[#343541] text-black dark:text-white
                            focus:outline-none"
                          value={editName}
                        ...
                        <textarea
                          className="w-full h-32 mb-2 px-3 py-2 text-sm rounded-md border border-gray-300
                            dark:border-gray-600 bg-white dark:bg-[#343541] text-black dark:text-white
                            focus:outline-none"
                          value={editContent}
                      ...
                      <>
                        <div className="p-2 border border-gray-300 dark:border-gray-600 rounded-md
                          bg-white dark:bg-[#343541] text-gray-800 dark:text-white mb-2 whitespace-pre-wrap">
                          {tpl.content}
                        </div>
